...
int main(int argc, char *argv[])
{
    ...
    int entry_n;
    unnormedTree->Branch("event_n", &entry_n, "event_n/I");
    int pdgID;
    unnormedTree->Branch("pdgID", &pdgID, "pdgID/I");
    int truth_type;
    unnormedTree->Branch("truth_type", &truth_type, "truth_type/I");

    float ptcone20;
    unnormedTree->Branch("baseline_ptcone20", &ptcone20, "baseline_ptcone20/F");
    float ptcone30;
    unnormedTree->Branch("baseline_ptcone30", &ptcone30, "baseline_ptcone30/F");
    float ptcone40;
    unnormedTree->Branch("baseline_ptcone40", &ptcone40, "baseline_ptcone40/F");
    float ptvarcone20;
    unnormedTree->Branch("baseline_ptvarcone20", &ptvarcone20, "baseline_ptvarcone20/F");
    float ptvarcone30;
    unnormedTree->Branch("baseline_ptvarcone30", &ptvarcone30, "baseline_ptvarcone30/F");
    float ptvarcone40;
    unnormedTree->Branch("baseline_ptvarcone40", &ptvarcone40, "baseline_ptvarcone40/F");
    float topoetcone20;
    unnormedTree->Branch("baseline_topoetcone20", &topoetcone20, "baseline_topoetcone20/F");
    float topoetcone30;
    unnormedTree->Branch("baseline_topoetcone30", &topoetcone30, "baseline_topoetcone30/F");
    float topoetcone40;
    unnormedTree->Branch("baseline_topoetcone40", &topoetcone40, "baseline_topoetcone40/F");
    float eflowcone20;
    unnormedTree->Branch("baseline_eflowcone20", &eflowcone20, "baseline_eflowcone20/F");
    float ptcone20_over_pt;
    unnormedTree->Branch("baseline_ptcone20_over_pt", &ptcone20_over_pt, "baseline_ptcone20_over_pt/F");
    float ptcone30_over_pt;
    unnormedTree->Branch("baseline_ptcone30_over_pt", &ptcone30_over_pt, "baseline_ptcone30_over_pt/F");
    float ptcone40_over_pt;
    unnormedTree->Branch("baseline_ptcone40_over_pt", &ptcone40_over_pt, "baseline_ptcone40_over_pt/F");
    float ptvarcone20_over_pt;
    unnormedTree->Branch("baseline_ptvarcone20_over_pt", &ptvarcone20_over_pt, "baseline_ptvarcone20_over_pt/F");
    float ptvarcone30_over_pt;
    unnormedTree->Branch("baseline_ptvarcone30_over_pt", &ptvarcone30_over_pt, "baseline_ptvarcone30_over_pt/F");
    float ptvarcone40_over_pt;
    unnormedTree->Branch("baseline_ptvarcone40_over_pt", &ptvarcone40_over_pt, "baseline_ptvarcone40_over_pt/F");
    float topoetcone20_over_pt;
    unnormedTree->Branch("baseline_topoetcone20_over_pt", &topoetcone20_over_pt, "baseline_topoetcone20_over_pt/F");
    float topoetcone30_over_pt;
    unnormedTree->Branch("baseline_topoetcone30_over_pt", &topoetcone30_over_pt, "baseline_topoetcone30_over_pt/F");
    float topoetcone40_over_pt;
    unnormedTree->Branch("baseline_topoetcone40_over_pt", &topoetcone40_over_pt, "baseline_topoetcone40_over_pt/F");
    float eflowcone20_over_pt;
    unnormedTree->Branch("baseline_eflowcone20_over_pt", &eflowcone20_over_pt, "baseline_eflowcone20_over_pt/F");
    //float PLT; unnormedTree->Branch("baseline_PLT", &PLT, "baseline_PLT/F");

    float calc_ptcone20;
    unnormedTree->Branch("calc_ptcone20", &calc_ptcone20, "calc_ptcone20/F");
    float calc_ptcone30;
    unnormedTree->Branch("calc_ptcone30", &calc_ptcone30, "calc_ptcone30/F");
    float calc_ptcone40;
    unnormedTree->Branch("calc_ptcone40", &calc_ptcone40, "calc_ptcone40/F");
    float calc_ptvarcone20;
    unnormedTree->Branch("calc_ptvarcone20", &calc_ptvarcone20, "calc_ptvarcone20/F");
    float calc_ptvarcone30;
    unnormedTree->Branch("calc_ptvarcone30", &calc_ptvarcone30, "calc_ptvarcone30/F");
    float calc_ptvarcone40;
    unnormedTree->Branch("calc_ptvarcone40", &calc_ptvarcone40, "calc_ptvarcone40/F");

    float etcone20;
    unnormedTree->Branch("baseline_etcone20", &etcone20, "baseline_etcone20/F");
    float etcone30;
    unnormedTree->Branch("baseline_etcone30", &etcone30, "baseline_etcone30/F");
    float etcone40;
    unnormedTree->Branch("baseline_etcone40", &etcone40, "baseline_etcone40/F");

    float calc_etcone20;
    unnormedTree->Branch("calc_etcone20", &calc_etcone20, "calc_etcone20/F");
    float calc_etcone30;
    unnormedTree->Branch("calc_etcone30", &calc_etcone30, "calc_etcone30/F");
    float calc_etcone40;
    unnormedTree->Branch("calc_etcone40", &calc_etcone40, "calc_etcone40/F");

    float coreV;
    unnormedTree->Branch("coreMuon", &coreV, "coreMuon/F");
    float coreCone;
    unnormedTree->Branch("coreCone", &coreCone, "coreCone/F");
    float ET_core;
    unnormedTree->Branch("ET_core", &ET_core, "ET_core/F");
    float pu_corr20;
    unnormedTree->Branch("pu_corr20", &pu_corr20, "pu_corr20/F");
    float pu_corr30;
    unnormedTree->Branch("pu_corr30", &pu_corr30, "pu_corr30/F");
    float pu_corr40;
    unnormedTree->Branch("pu_corr40", &pu_corr40, "pu_corr40/F");

    float pt_corr20;
    unnormedTree->Branch("pt_corr20", &pt_corr20, "pt_corr20/F");
    float pt_corr30;
    unnormedTree->Branch("pt_corr30", &pt_corr30, "pt_corr30/F");
    float pt_corr40;
    unnormedTree->Branch("pt_corr40", &pt_corr40, "pt_corr40/F");

    float calc_coreCone;
    unnormedTree->Branch("calc_coreCone", &calc_coreCone, "calc_coreCone/F");

    float lep_pT;
    unnormedTree->Branch("lep_pT", &lep_pT, "lep_pT/F");
    unnormedTree->Branch("ROC_slicing_lep_pT", &lep_pT, "ROC_slicing_lep_pT/F"); // for making ROC curve plots
    float lep_eta;
    unnormedTree->Branch("lep_eta", &lep_eta, "lep_eta/F");
    float lep_theta;
    unnormedTree->Branch("lep_theta", &lep_theta, "lep_theta/F");
    float lep_phi;
    unnormedTree->Branch("lep_phi", &lep_phi, "lep_phi/F");
    float lep_d0;
    unnormedTree->Branch("lep_d0", &lep_d0, "lep_d0/F");
    float lep_d0_over_sigd0;
    unnormedTree->Branch("lep_d0_over_sigd0", &lep_d0_over_sigd0, "lep_d0_over_sigd0/F");
    float lep_z0;
    unnormedTree->Branch("lep_z0", &lep_z0, "lep_z0/F");
    float lep_dz0;
    unnormedTree->Branch("lep_dz0", &lep_dz0, "lep_dz0/F");
    int lep_has_associated_jet;
    unnormedTree->Branch("lep_has_associated_jet", &lep_has_associated_jet, "lep_has_associated_jet/I");
    float lep_DL1r;
    unnormedTree->Branch("lep_DL1r", &lep_DL1r, "lep_DL1r/F");

    vector<float> *trk_lep_dR = new vector<float>;
    unnormedTree->Branch("trk_lep_dR", "vector<float>", &trk_lep_dR);
    vector<float> *trk_pT = new vector<float>;
    unnormedTree->Branch("trk_pT", "vector<float>", &trk_pT);
    vector<float> *trk_eta = new vector<float>;
    unnormedTree->Branch("trk_eta", "vector<float>", &trk_eta);
    vector<float> *trk_phi = new vector<float>;
    unnormedTree->Branch("trk_phi", "vector<float>", &trk_phi);
    vector<float> *trk_d0 = new vector<float>;
    unnormedTree->Branch("trk_d0", "vector<float>", &trk_d0);
    vector<float> *trk_z0 = new vector<float>;
    unnormedTree->Branch("trk_z0", "vector<float>", &trk_z0);
    vector<float> *trk_lep_dEta = new vector<float>;
    unnormedTree->Branch("trk_lep_dEta", "vector<float>", &trk_lep_dEta);
    vector<float> *trk_lep_dPhi = new vector<float>;
    unnormedTree->Branch("trk_lep_dPhi", "vector<float>", &trk_lep_dPhi);
    vector<float> *trk_lep_dD0 = new vector<float>;
    unnormedTree->Branch("trk_lep_dD0", "vector<float>", &trk_lep_dD0);
    vector<float> *trk_lep_dZ0 = new vector<float>;
    unnormedTree->Branch("trk_lep_dZ0", "vector<float>", &trk_lep_dZ0);
    vector<float> *trk_chi2 = new vector<float>;
    unnormedTree->Branch("trk_chi2", "vector<float>", &trk_chi2);
    vector<int> *trk_charge = new vector<int>;
    unnormedTree->Branch("trk_charge", "vector<int>", &trk_charge);
    vector<int> *trk_nIBLHits = new vector<int>;
    unnormedTree->Branch("trk_nIBLHits", "vector<int>", &trk_nIBLHits);
    vector<int> *trk_nPixHits = new vector<int>;
    unnormedTree->Branch("trk_nPixHits", "vector<int>", &trk_nPixHits);
    vector<int> *trk_nPixHoles = new vector<int>;
    unnormedTree->Branch("trk_nPixHoles", "vector<int>", &trk_nPixHoles);
    vector<int> *trk_nPixOutliers = new vector<int>;
    unnormedTree->Branch("trk_nPixOutliers", "vector<int>", &trk_nPixOutliers);
    vector<int> *trk_nSCTHits = new vector<int>;
    unnormedTree->Branch("trk_nSCTHits", "vector<int>", &trk_nSCTHits);
    vector<int> *trk_nSCTHoles = new vector<int>;
    unnormedTree->Branch("trk_nSCTHoles", "vector<int>", &trk_nSCTHoles);
    vector<int> *trk_nTRTHits = new vector<int>;
    unnormedTree->Branch("trk_nTRTHits", "vector<int>", &trk_nTRTHits);
    vector<float> *trk_vtx_x = new vector<float>;
    unnormedTree->Branch("trk_vtx_x", "vector<float>", &trk_vtx_x);
    vector<float> *trk_vtx_y = new vector<float>;
    unnormedTree->Branch("trk_vtx_y", "vector<float>", &trk_vtx_y);
    vector<float> *trk_vtx_z = new vector<float>;
    unnormedTree->Branch("trk_vtx_z", "vector<float>", &trk_vtx_z);
    vector<int> *trk_vtx_type = new vector<int>;
    unnormedTree->Branch("trk_vtx_type", "vector<int>", &trk_vtx_type);

    // See https://twiki.cern.ch/twiki/bin/view/AtlasProtected/EGammaD3PDtoxAOD
    vector<float> *calo_cluster_lep_dR = new vector<float>;
    unnormedTree->Branch("calo_cluster_lep_dR", "vector<float>", &calo_cluster_lep_dR);
    vector<float> *calo_cluster_e = new vector<float>;
    unnormedTree->Branch("calo_cluster_e", "vector<float>", &calo_cluster_e);
    vector<float> *calo_cluster_pT = new vector<float>;
    unnormedTree->Branch("calo_cluster_pT", "vector<float>", &calo_cluster_pT);
    vector<float> *calo_cluster_eta = new vector<float>;
    unnormedTree->Branch("calo_cluster_eta", "vector<float>", &calo_cluster_eta);
    vector<float> *calo_cluster_phi = new vector<float>;
    unnormedTree->Branch("calo_cluster_phi", "vector<float>", &calo_cluster_phi);
    ...
    vector<float> *calo_cluster_lep_dEta = new vector<float>;
    unnormedTree->Branch("calo_cluster_lep_dEta", "vector<float>", &calo_cluster_lep_dEta);
    vector<float> *calo_cluster_lep_dPhi = new vector<float>;
    unnormedTree->Branch("calo_cluster_lep_dPhi", "vector<float>", &calo_cluster_lep_dPhi);

    vector<int> *calo_cluster_size = new vector<int>;
    unnormedTree->Branch("calo_cluster_size", "vector<int>", &calo_cluster_size);
    ...
    auto process_lepton = [&](const xAOD::IParticle *lepton, const xAOD::Vertex *primary_vertex, const vector<const xAOD::TrackParticle *> &filtered_tracks, vector<const xAOD::CaloCluster *> &filtered_calo_clusters, vector<const xAOD::Jet *> &filtered_jets, double rho_central, double rho_forward, bool is_electron) {
        ...
        if (is_electron)
            track_particle = ((xAOD::Electron *)lepton)->trackParticle();
        else
            track_particle = ((xAOD::Muon *)lepton)->trackParticle(xAOD::Muon::InnerDetectorTrackParticle);
        ...
        if (is_electron)
            process_electron_cones((const xAOD::Electron *)lepton);
        else
            process_muon_cones((const xAOD::Muon *)lepton);
        ...
        if (is_electron)
            own_tracks = get_electron_own_tracks((const xAOD::Electron *)lepton);
        else
            own_tracks = get_muon_own_tracks((const xAOD::Muon *)lepton);
        ...
        if (is_electron)
        {
            ...
            for (auto trk : filtered_tracks)
            {
                ...
                for (auto own_track : electron_tracks)
                    if (trk == own_track)
                        matches_own_track = true;
                if (matches_own_track)
                    continue;
                if (trk->vertex() && trk->vertex() != primary_vertex)
                    continue;
                if (trk->p4().DeltaR(lepton->p4()) < 0.20)
                    calc_ptcone20 += trk->pt();
                if (trk->p4().DeltaR(lepton->p4()) < 0.30)
                    calc_ptcone30 += trk->pt();
                if (trk->p4().DeltaR(lepton->p4()) < 0.40)
                    calc_ptcone40 += trk->pt();
                if (trk->p4().DeltaR(lepton->p4()) < var_R_20)
                    calc_ptvarcone20 += trk->pt();
                if (trk->p4().DeltaR(lepton->p4()) < var_R_30)
                    calc_ptvarcone30 += trk->pt();
                if (trk->p4().DeltaR(lepton->p4()) < var_R_40)
                    calc_ptvarcone40 += trk->pt();
            }
            ...
            float dR20 = xAOD::Iso::coneSize(xAOD::Iso::topoetcone20);
            pu_corr20 = rho * (dR20 * dR20 * M_PI - areacore); //if (pu_corr20!= 0) cout<<"elec:pu20: " <<pu_corr20<<endl;
            float dR30 = xAOD::Iso::coneSize(xAOD::Iso::topoetcone30);
            pu_corr30 = rho * (dR30 * dR30 * M_PI - areacore); //if (pu_corr30!= 0) cout<<"elec:pu30: " <<pu_corr30<<endl;
            float dR40 = xAOD::Iso::coneSize(xAOD::Iso::topoetcone40);
            pu_corr40 = rho * (dR40 * dR40 * M_PI - areacore); //if (pu_corr40!= 0) cout<<"elec:pu40: " <<pu_corr40<<endl;
            ...
            float phi_calo = electron->caloCluster()->phi();
            float eta_calo = electron->caloCluster()->eta();
            ...
            for (const auto &clus : filtered_calo_clusters)
            {
                ...
                float dPhi = TVector2::Phi_mpi_pi(clus->phi() - phi_calo);
                float dEta = clus->eta() - eta_calo;
            ...
            calc_etcone30 -= coreV;
            calc_etcone40 -= coreV;
            calc_etcone20 -= pu_corr20;
            calc_etcone30 -= pu_corr30;
            calc_etcone40 -= pu_corr40;
            calc_etcone20 -= pt_corr20;
            calc_etcone30 -= pt_corr30;
            calc_etcone40 -= pt_corr40;
        }
        else
        {
            ...
            if (muon->isAvailable<float>("ET_Core"))
                ET_core = muon->auxdataConst<float>("ET_Core");
            ...
            float dR20 = xAOD::Iso::coneSize(xAOD::Iso::topoetcone20);
            pu_corr20 = rho * (dR20 * dR20 * M_PI - areacore); //if (pu_corr20!= 0) cout<<"mu:pu20: " <<pu_corr20<<endl;
            float dR30 = xAOD::Iso::coneSize(xAOD::Iso::topoetcone30);
            pu_corr30 = rho * (dR30 * dR30 * M_PI - areacore); //if (pu_corr30!= 0) cout<<"mu:pu30: " <<pu_corr30<<endl;
            float dR40 = xAOD::Iso::coneSize(xAOD::Iso::topoetcone40);
            pu_corr40 = rho * (dR40 * dR40 * M_PI - areacore); //if (pu_corr40!= 0) cout<<"mu:pu40: " <<pu_corr40<<endl;

            float phi_calo = own_track->phi();
            float eta_calo = own_track->eta();
            ...
            for (const auto &clus : filtered_calo_clusters)
            {
                ...
                */
                ...
                if (m_addCaloDeco && !Decorated.isAvailable(*tp))
                    decorateTrackCaloPosition(*tp, eta, phi);
                return true;
                */
                float dPhi = TVector2::Phi_mpi_pi(clus->phi() - phi_calo);
                float dEta = clus->eta() - eta_calo;
            ...
            calc_etcone20 -= coreCone;
            calc_etcone30 -= coreCone;
            calc_etcone40 -= coreCone;
            calc_etcone20 -= pu_corr20;
            calc_etcone30 -= pu_corr30;
            calc_etcone40 -= pu_corr40;
        }
        ...
        {
            if (!track->vertex() or track->vertex() != primary_vertex)
                continue;
            bool matches_own_track = false;
            for (auto own_track : own_tracks)
                if (track == own_track)
                    matches_own_track = true;
            if (filter_own_tracks && matches_own_track)
                continue;
            ...
            if (!matches_own_track)
                has_associated_tracks = true; // don't count the lepton's own tracks
            ...
            uint8_t placeholder;
            track->summaryValue(placeholder, xAOD::numberOfInnermostPixelLayerHits);
            trk_nIBLHits->push_back(placeholder);
            track->summaryValue(placeholder, xAOD::numberOfPixelHits);
            trk_nPixHits->push_back(placeholder);
            track->summaryValue(placeholder, xAOD::numberOfPixelHoles);
            trk_nPixHoles->push_back(placeholder);
            track->summaryValue(placeholder, xAOD::numberOfPixelOutliers);
            trk_nPixOutliers->push_back(placeholder);
            track->summaryValue(placeholder, xAOD::numberOfSCTHits);
            trk_nSCTHits->push_back(placeholder);
            track->summaryValue(placeholder, xAOD::numberOfSCTHoles);
            trk_nSCTHoles->push_back(placeholder);
            track->summaryValue(placeholder, xAOD::numberOfTRTHits);
            trk_nTRTHits->push_back(placeholder);
        ...
        calo_cluster_lep_dR->clear();
        calo_cluster_e->clear();
        calo_cluster_pT->clear();
        calo_cluster_eta->clear();
        calo_cluster_phi->clear();
        /*calo_cluster_etamoment->clear(); calo_cluster_phimoment->clear();*/ calo_cluster_lep_dEta->clear();
        calo_cluster_lep_dPhi->clear();
    ...
    for (entry_n = 0; entry_n < entries; ++entry_n)
    {
        ...
        if (entry_n % 500 == 0)
            cout << "Processed electrons: " << electron_number << "\n";
        if (entry_n % 500 == 0)
            cout << "Processed filtered electrons: " << filtered_electron_number << "\n";
        ...
        for (auto electron_info : filtered_electrons)
        {
            ...
            truth_type = electron_info.second;
            pdgID = 11;
            if (!process_lepton(electron, primary_vertex, filtered_tracks, filtered_calo_clusters, filtered_jets, rho_central, rho_forward, true))
                continue;
        ...
        for (auto muon_info : filtered_muons)
        {
            ...
            truth_type = muon_info.second;
            pdgID = 13;
            if (!process_lepton(muon, primary_vertex, filtered_tracks, filtered_calo_clusters, filtered_jets, rho_central, rho_forward, false))
                continue;
    ...
    for (int i = 0; i < myBranches->GetEntries(); i++)
    {
        ...
        int intVar = -1;
        float floatVar = -1;
        vector<int> *intVecVar = new vector<int>;
        vector<float> *floatVecVar = new vector<float>;
        if (varType == "I")
            fillNonVecBranch(intVar);
        else if (varType == "F")
            fillNonVecBranch(floatVar);
        else if (varType == "vector<int>")
            fillVecBranch(intVecVar);
        else if (varType == "vector<float>")
            fillVecBranch(floatVecVar);
    }
